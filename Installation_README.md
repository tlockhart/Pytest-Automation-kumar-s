...
# Test Commands:
## pytest -v : verbose
## pytest Pytest_topics/test_skiptests.py -v
## run test marked sanity: pytest Pytest_topics/test_markers.py -v -m sanity
## run test marked sanity and but not str: pytest Pytest_topics/test_markers.py -v -m "sanity and not str"
